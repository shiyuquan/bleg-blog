...
public class BasicRowProcessor {
     ...
     * constructor.
     */
    private static final syq.bleg.base.db.jdbc.BeanProcessor defaultConvert = new syq.bleg.base.db.jdbc.BeanProcessor();

    /**
     * Use this to process beans.
     */
    private final syq.bleg.base.db.jdbc.BeanProcessor convert;
     ...
     *            properties.
     */
    public BasicRowProcessor(syq.bleg.base.db.jdbc.BeanProcessor convert) {
        super();
