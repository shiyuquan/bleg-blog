...
public class BasicRowProcessor {
     ...
     * constructor.
     */
    private static final syq.bleg.utils.jdbc.BeanProcessor defaultConvert = new syq.bleg.utils.jdbc.BeanProcessor();

    /**
     * Use this to process beans.
     */
    private final syq.bleg.utils.jdbc.BeanProcessor convert;
     ...
     *            properties.
     */
    public BasicRowProcessor(syq.bleg.utils.jdbc.BeanProcessor convert) {
        super();
